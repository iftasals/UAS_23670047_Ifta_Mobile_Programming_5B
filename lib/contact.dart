...
class _ContactPageState extends State<ContactPage> {
  ...
  // FUNGSI WHATSAPP - DENGAN PESAN OTOMATIS
  Future<void> _launchWhatsApp() async {
    ...
    // Pesan otomatis yang sudah ditentukan
  ...
  void _navigateToPage(int index) async {
    ...
    if (index == 0) {
      ...
      Navigator.pushReplacement(
        ...
        MaterialPageRoute(
          builder: (context) =>
              OrderFormPage(currentUser: userName ?? 'Pelanggan'),
        ),
      );
    }
  }
